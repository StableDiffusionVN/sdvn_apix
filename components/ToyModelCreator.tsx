                    ...
                    <AppOptionsLayout>
                        ...
                        <OptionsPanel>
                            ...
                            <div>
                                ...
                                <textarea id="notes" value={appState.options.notes} onChange={(e) => handleOptionChange('notes', e.target.value)} placeholder={t('toyModelCreator_notesPlaceholder')} className="form-input h-24" rows={3} />
                            </div>
